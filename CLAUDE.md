...
This project is indexed by GitNexus as **marketplace-dev-admin-authenticated-resource**. Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/marketplace-dev-admin-authenticated-resource/context` | Codebase overview, check index freshness |
| `gitnexus://repo/marketplace-dev-admin-authenticated-resource/clusters` | All functional areas |
| `gitnexus://repo/marketplace-dev-admin-authenticated-resource/processes` | All execution flows |
| `gitnexus://repo/marketplace-dev-admin-authenticated-resource/process/{name}` | Step-by-step execution trace |
