...
export const reuseEvents = {
	 ...
	 * would be a knob over a list that is already short — while inviting the platform-wide read that
	 * `sessions` rules out for the same reason. What an admin reads is the whole trail or nothing.
	 */
	args: {
