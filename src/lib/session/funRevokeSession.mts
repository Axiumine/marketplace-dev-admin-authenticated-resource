 ...
 * the admin's screen naming a session that cannot be ended, and every attempt would answer success
 ...
 * refresh sessions are indexed (`indexSession`), so the row the admin clicked names one half of a pair;
 ...
 * that expired between the admin's read and their click, both answer `null` — the pre-2026-08-13
