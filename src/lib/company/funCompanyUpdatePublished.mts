 ...
 *
 * ⚠️ **Nothing records that it was an admin who flipped it.** The owner can publish the shop again
 ...
 * can bypass. The driver's rejection reaches the admin through `tryCatchRethrow`.
 *
